...
// To publish changes: replace this file with the one the
// editor downloads, commit, and Pages redeploys automatically.
// ============================================================
window.SITE_CONFIG = {
  theme: {
    ink: "#0e0e0c",
  ...
  hero: {
    ...
    badge: "★ Folio ’26",
    tag: "Designing loud identities\nfor quiet brands — and\nthe other way around.",
    scroll: "Scroll"
  },
  marquee: ["Brand Identity", "Art Direction", "Editorial Design", "Type Design", "Packaging", "Motion"],
  about: {
    label: "About",
    statement: "I turn brand strategy into visual systems people actually remember. Ten years of posters, identities and screens — built on type, grids, and a healthy disrespect for both.",
    p1: "I’m Oscar — an independent designer working between Barcelona and wherever the project lives. I partner with founders, studios and cultural institutions to build identities that survive contact with the real world: airports, lockscreens, tote bags, 3 a.m. pitch decks.",
    p2: "Previously design lead at Studio Rauw (AMS) and Otra (BCN). My work has been recognised by ADC, D&AD and the Type Directors Club.",
    stats: [
      { n: 10, label: "Years of practice" },
      { n: 64, label: "Projects shipped" },
  ...
  work: {
    ...
    years: "’21 — ’26",
    items: [
      { name: "Mono Records", meta: "Identity · Packaging", year: "2026" },
      { name: "Café Brut", meta: "Branding · Signage", year: "2025" },
      { name: "Ojo Festival", meta: "Art Direction · Motion", year: "2024" },
      { name: "Norr Atelier", meta: "Identity · Editorial", year: "2023" },
      { name: "Liminal Type Co.", meta: "Type Design · Web", year: "2022" }
    ]
  },
  services: {
    label: "What I Do",
    items: [
      { title: "Brand Identity", body: "Naming, logotypes, visual systems and guidelines that scale from a favicon to a festival stage. Strategy first, decoration last." },
      { title: "Art Direction", body: "Campaigns, photoshoots and motion language. I set the visual world and direct the people who bring it to life." },
      { title: "Editorial & Type", body: "Books, magazines and custom typefaces. Grids you can feel, letterforms with opinions." },
      { title: "Digital Design", body: "Sites and product surfaces designed with developers in the room — so what ships looks like what was signed off." }
    ]
  },
  contact: {
    kicker: "Got a project, a brand,\nor just a hunch?",
    cta1: "LET’S",
    cta2: "TALK",
    email: "hello@oscarnieto.studio",
    socials: ["Instagram", "Behance", "Are.na"],
