...
(function () {
  ...
  const SCHEMA = [
    ...
    { title: "Portada (hero)", fields: [
      { path: "hero.line1", label: "Palabra central", type: "text" },
      { path: "hero.words", label: "Palabras alrededor (una por línea, máx. 12)", type: "list" },
      { path: "hero.line2", label: "Apellido (solo pantalla de carga)", type: "text" },
